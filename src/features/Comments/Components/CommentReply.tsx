import { AnswerContent } from "../../../types/global";

function CommentReply({ answerContent }: { answerContent: AnswerContent }) {
  return (
    <div className="m-2 rounded bg-slate-200 p-1 sm:m-4 dark:bg-slate-700">
      <div className="mb-3 ml-2 mt-2 flex items-center">
        ...
        <div className="ml-5">
          ...
          <p className="">{answerContent.createdAt.slice(0, 10)}</p>
        </div>
      </div>
