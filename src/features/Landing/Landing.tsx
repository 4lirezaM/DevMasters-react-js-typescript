...
import Landingcart from "./components/Landingcart.tsx";
import Searchfield from "./components/Searchfield.tsx";
import { typingAnimation } from "../../utils/animation.ts";
import { useRef } from "react";

function Landing() {
  const timeoutIdRef = useRef<ReturnType<typeof setTimeout> | null>(null);
  useEffect(() => {
    const animationTargetElement = document.getElementById(
      "landing__typingElement",
    );
    if (!animationTargetElement)
      throw new Error(
        "there is an error with getting element of typing animation",
      );
    const startIndex = 0;
    typingAnimation(
      "Elevate Your Programming Skills to Mastery!",
      startIndex,
  ...
  return (
    <section>
      <div className="relative h-[330px] w-full bg-[url('/images/background_landing.jfif')] bg-cover bg-fixed bg-no-repeat text-white sm:h-[550px]">
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-60">
          <h1 className="text-center text-3xl font-bold sm:text-7xl">
            DevMasters Academy
          </h1>
          <h3
            id="landing__typingElement"
            className="mt-1 text-center text-lg sm:text-3xl"
          >
            {/* Elevate Your Programming Skills to Mastery! */}
            {/* Master the art of programming with DevMasters. */}
          </h3>
          <Searchfield />
          <div className="hidden items-center justify-center px-0 py-4 sm:flex sm:p-3 md:p-6">
            <Landingcart
              title="Minutes of Pure Knowledge"
              count={31320}
              svgclass="pr-4"
            >
              <svg
            ...
            <Landingcart title="Masterpiece Courses" count={40}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
                id="Capa_1"
            ...
            <Landingcart title="Knowledge Seekers" count={2027}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                id="Capa_1"
                height="80"
